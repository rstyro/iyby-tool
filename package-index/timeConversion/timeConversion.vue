				...
				<view class="form-item">
					...
					<picker mode="date" :value="startDate" @change="startDateChange">
						<view class="picker-input">
							...
							<cl-icon type="icon-riqijisuan" color="#606266" size="20"></cl-icon>
						</view>
					</picker>
				</view>
		...
		<view class="card">
			...
			<view class="card-body">
				...
				<button class="action-button" @click="copyTimestamp">
					<cl-icon type="icon-fuzhi" color="#fff" size="20"></cl-icon>
					<text>复制时间戳</text>
				</button>
			</view>
		</view>
		...
		<view class="card">
			...
			<view class="card-body">
				...
				<view class="form-item">
					...
					<input class="input" type="number" v-model="addDays" placeholder="负数是减,正数是加"
		...
		methods: {
			generateShareConfig(forTimeline = false) {
				const defaultTemplates = [
					...
					"⚡️ 时间转换，快人一步！分享一个超好用的【日期时间转换工具】！",
					"把 “1767196740” 变成 “2025-12-31” (新年快乐！🥳)",
