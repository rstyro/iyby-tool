  ...
  <view class="container">
    ...
    <view class="section">
      ...
      <view class="content">
        ...
        <!-- 操作按钮 -->
        <button type="primary" class="calc-btn" @click="convert">立即转换</button>
      </view>
    </view>
    ...
    <view class="section">
      ...
      <view class="content">
        ...
        <view class="action-bar">
          <button type="primary" size="mini" @click="copyResult">复制结果</button>
          <button type="default" size="mini" @click="clearAll">清空</button>
        </view>
      </view>
    </view>
  </view>
...
<script>
// import { baseConversion, copyData } from '@/utils/Tools.js';
...
export default {
  ...
  methods: {
    ...
    initBaseList() {
      ...
      this.baseList = bases.map(n => ({text: `${n}进制`, value: n}));
    ...
    handleInput(e) {
      ...
      if (this.params.base <= 10 && /[^0-9]/.test(value)) {
        uni.showToast({ title: '仅允许输入数字', icon: 'none' });
        this.clearResults();
        return;
      }
