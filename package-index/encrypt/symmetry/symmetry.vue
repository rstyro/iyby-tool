      ...
      <view class="params-box">
        ...
        <view v-if="currentAlgorithm === 'AES'" class="aes-params">
          ...
          <view class="param-item">
            ...
            <picker 
              class="param-picker" 
              :value="params.paddingIndex" 
              :range="aes.paddingList" 
              range-key="text"
              @change="changePadding($event)"
            >
...
export default {
  data() {
    return {
      ...
      algorithms: [
        { value: 'AES', name: 'AES' },
        { value: 'DES', name: 'DES' },
        { value: 'TripleDES', name: '3DES' },
        { value: 'Rabbit', name: 'Rabbit' },
        { value: 'RC4', name: 'RC4' },
        { value: 'RC4Drop', name: 'RC4Drop' }
      ],
      aes: {
        modeList: [
          { value: "ECB", text: "ECB" },
        ...
        paddingList: [
          { value: "Pkcs7", text: "Pkcs7" },
          { value: "Iso97971", text: "Iso97971" },
          { value: "AnsiX923", text: "AnsiX923" },
          { value: "Iso10126", text: "Iso10126" },
          { value: "ZeroPadding", text: "ZeroPadding" },
          { value: "NoPadding", text: "NoPadding" }
        ]
      }
    };
  },
  computed: {
    keyPlaceholder() {
      switch(this.currentAlgorithm) {
        case 'AES': return '16/24/32个字符';
        case 'DES': return '8个字符';
        case 'TripleDES': return '24个字符';
        default: return '输入密钥';
      }
    }
  },
  methods: {
      ...
      try {
        ...
        switch(this.currentAlgorithm) {
          ...
          case 'RC4Drop':
            ...
            encrypted = CryptoJS.RC4Drop.encrypt(this.content, key, { drop: dropBit });
            break;
        }
    ...
    decodeContent() {
      if (!this.result) {
        uni.showToast({ title: '加密内容为空', icon: 'none' });
        return;
      }
      ...
      try {
        ...
        switch(this.currentAlgorithm) {
          ...
          case 'RC4Drop':
            const dropBit = this.params.drop * 4;
            decrypted = CryptoJS.RC4Drop.decrypt(this.result, key, { drop: dropBit });
            break;
        }
