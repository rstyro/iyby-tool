<template>
  <view class="container">
    ...
    <view class="header">
      ...
      <text class="subtitle">将图片切割成多个小图片</text>
    </view>
    ...
    <view class="control-section">
      ...
      <view class="cut-mode-control">
        ...
        <view class="cut-mode-buttons">
          <button 
            class="cut-mode-btn" 
            :class="{ active: cutMode === '3x3' }"
            @click="setCutMode('3x3')"
          >
            3×3
          </button>
          <button 
            class="cut-mode-btn" 
            :class="{ active: cutMode === '2x3' }"
            @click="setCutMode('2x3')"
          >
            2×3
          </button>
          <button 
            class="cut-mode-btn" 
            :class="{ active: cutMode === '1x3' }"
            @click="setCutMode('1x3')"
          >
            1×3
          </button>
          <button 
            class="cut-mode-btn" 
            :class="{ active: cutMode === '3x2' }"
            @click="setCutMode('3x2')"
          >
            3×2
          </button>
          <button 
            class="cut-mode-btn" 
            :class="{ active: cutMode === '2x2' }"
            @click="setCutMode('2x2')"
          >
            2×2
          </button>
        </view>
      ...
      <view class="custom-cut-control">
        ...
        <button 
          class="custom-cut-btn" 
          :class="{ active: cutMode === 'custom' }"
          @click="setCutMode('custom')"
        >
          应用自定义
        </button>
      </view>
      ...
      <button 
        ...
        @click="startCut"
        :disabled="!originalImage || isCutting"
      >
    ...
    <view class="result-section" v-if="cutPieces.length > 0">
      ...
      <view class="cut-preview">
        ...
        >
          <view 
            v-for="(piece, index) in cutPieces" 
            :key="index" 
            class="preview-cell"
          >
...
.cut-mode-label, .custom-cut-label {
  font-size: 28rpx;
  color: #333;
  display: block;
  margin-bottom: 15rpx;
...
@keyframes fadeInOut {
  0%, 100% { opacity: 0; transform: translateX(-50%) translateY(20rpx); }
